...
public class UserSettingsResource {
    ...
    public ResponseEntity<UserDTO> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException, JSONException {
        ...
        // Remove the password, so we don't store plain passwords anywhere
    ...
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
        ...
        //TODO: fetch User info from UAA and populate missing values in the UserDTO
