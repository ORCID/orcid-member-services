...
public class OrcidScheduledJobsManager {
    ...
    @Scheduled(initialDelay = 90000l, fixedDelayString = "${application.syncAffiliationsDelay}")
    ...
    @Scheduled(initialDelay = 90000l, cron = "${application.generateMemberAssertionStatsCron}")
    ...
    @Scheduled(initialDelay = 90000l, fixedDelayString = "${application.processAssertionUploadsDelay}")
    ...
    @Scheduled(initialDelay = 90000l, fixedDelayString = "${application.removeStoredFilesDelay}")
