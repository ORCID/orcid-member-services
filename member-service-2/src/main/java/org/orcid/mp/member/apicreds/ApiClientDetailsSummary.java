...
/**
 * Mirrors org.orcid.apicreds.dto.ClientDetailsSummaryDto (api-credentials-service) —
 * the read-only shape returned by the search endpoint.
 */
public class ApiClientDetailsSummary {
