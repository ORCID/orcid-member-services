package org.orcid.mp.assertion.upload;
...
@Component
public class AssertionsCsvReader {
    ...
    private Assertion processDates(CSVRecord line, AssertionsUpload upload, Assertion a, User user) {
    ...
    private Assertion processUrl(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processDisambiguatedOrgId(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processDisambiguationSource(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processOrgCity(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processOrgCountry(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processOrgName(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processEndDate(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processStartDate(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private AssertionsUpload.AssertionsUploadDate getDate(CSVRecord line, AssertionsUpload upload, String elementName, User user) {
        String year = null;
        String month = null;
        String day = null;
    ...
    private Assertion processAffiliationSection(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processId(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
    ...
    private Assertion processEmail(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
        String id = getOptionalNullableValue(line, "id");
    ...
    protected boolean validDate(String date, String year, String day, CSVRecord line, AssertionsUpload upload, User user) {
    ...
    private void checkStartDateBeforeEndDate(CSVRecord line, Assertion a, AssertionsUpload upload, User user) {
        AssertionsUpload.AssertionsUploadDate startDate = getDate(line, upload, "start-date", user);
        AssertionsUpload.AssertionsUploadDate endDate = getDate(line, upload, "end-date", user);
