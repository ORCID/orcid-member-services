...
public class MailService {
	...
	public MailService(ApplicationProperties applicationProperties, MessageSource messageSource,
			SpringTemplateEngine templateEngine, MailgunClient mailgunClient) {
