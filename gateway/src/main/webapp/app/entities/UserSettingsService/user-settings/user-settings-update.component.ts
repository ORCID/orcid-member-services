...
export class UserSettingsUpdateComponent implements OnInit {
  ...
  updateForm(userSettings: IUserSettings) {
    this.editForm.patchValue({
      ...
      assertionServicesEnabled: userSettings.assertionServicesEnabled,
  ...
  private createFromForm(): IUserSettings {
    return {
      ...
      assertionServicesEnabled: this.editForm.get(['assertionServicesEnabled']).value,
