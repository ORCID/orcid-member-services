...
describe('Component Tests', () => {
  describe('MSMember Management Component', () => {
    let comp: MSMemberComponent;
    let fixture: ComponentFixture<MSMemberComponent>;
    let service: MSMemberService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [GatewayTestModule],
        declarations: [MSMemberComponent],
        providers: [
          {
      ...
      fixture = TestBed.createComponent(MSMemberComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.msMember[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
