...
import { MemberSettingsComponent } from 'app/entities/UserSettingsService/member-settings/member-settings.component';
...
describe('Component Tests', () => {
  describe('MemberSettings Management Component', () => {
    let comp: MemberSettingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MemberSettingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.memberSettings[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
