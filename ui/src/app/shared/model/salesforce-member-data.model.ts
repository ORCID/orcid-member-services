...
export interface ISFMemberData {
  ...
  consortiumLeadName?: string | null;
  consortiumMembers?: ISFConsortiumMemberData[] | null;
...
export class SFMemberData implements ISFMemberData {
  constructor(
    ...
    public consortiumLeadName?: string | null,
    public consortiumMembers?: SFConsortiumMemberData[] | null,
