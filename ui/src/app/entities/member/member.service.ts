...
export class MSMemberService {
  ...
  getMemberContacts(): Observable<SFMemberContact[] | null> {
  ...
  getMemberOrgIds(): Observable<SFMemberOrgId | null> {
  ...
  protected convertToSalesforceMemberContacts(res: SalesforceContactsResponseType): SFMemberContact[] | null  {
  ...
  protected convertToMemberOrgIds(res: SalesforceOrgIdResponseType): SFMemberOrgId | null {
    if (res.body && res.body.records!.length > 0) {
