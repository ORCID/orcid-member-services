...
export class UserUpdateComponent {
  ...
  validateOrgOwners() {
    this.isSaving = true;
    if (this.editForm.get('salesforceId')?.value) {
      this.userService.hasOwner(this.editForm.get('salesforceId')?.value!).subscribe(value => {
        this.isSaving = false;
  ...
  displaySendActivate() {
    if (this.existentUser && this.existentUser.email && !this.existentUser.activated) {
      console.log('this.existentMSUser: ', this.existentUser);
      console.log('this.existentMSUser.activated', this.existentUser.activated);
      return true;
    }
    return false;
  }
