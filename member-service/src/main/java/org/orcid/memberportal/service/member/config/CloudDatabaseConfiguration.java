...
@Configuration
@EnableMongoRepositories("org.orcid.memberportal.service.member.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud, Environment environment) {
        ...
        mongobee.setChangeLogsScanPackage("org.orcid.memberportal.service.member.config.dbmigrations");
