...
public class AccountResourceIT {
    ...
    @Autowired
    private SimpleExceptionHandler exceptionTranslator;
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account").accept(MediaType.APPLICATION_JSON_VALUE)).andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE)).andExpect(jsonPath("$.firstName").value("john"))
                ...
                .andExpect(jsonPath("$.authorities", Matchers.containsInAnyOrder(AuthoritiesConstants.USER, AuthoritiesConstants.ADMIN, AuthoritiesConstants.ASSERTION_SERVICE_ENABLED)));
    }
    ...
    public void testSaveAccount() throws Exception {
        ...
        restMvc.perform(post("/api/account").contentType(RestTestUtil.APPLICATION_JSON_UTF8).content(RestTestUtil.convertObjectToJsonBytes(userDTO)))
    ...
    @Test
    @WithMockUser("save-existing-email@example.com")
    public void testUpdateCurrentUserEmailFails() throws Exception {
        User user = new User();
        user.setEmail("save-existing-email@example.com");
        user.setPassword(RandomStringUtils.random(60));
        user.setActivated(true);
    ...
    public void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password").contentType(RestTestUtil.APPLICATION_JSON_UTF8)
                .content(RestTestUtil.convertObjectToJsonBytes(new PasswordChangeDTO("1" + currentPassword, "new password")))).andExpect(status().isBadRequest());
    ...
    public void testChangePassword() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password").contentType(RestTestUtil.APPLICATION_JSON_UTF8)
                .content(RestTestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "new password")))).andExpect(status().isOk());
    ...
    public void testChangePasswordEmpty() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password").contentType(RestTestUtil.APPLICATION_JSON_UTF8)
                .content(RestTestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "")))).andExpect(status().isBadRequest());
    ...
    public void testFinishPasswordResetTooSmall() throws Exception {
        ...
        restMvc.perform(post("/api/account/reset-password/finish").contentType(RestTestUtil.APPLICATION_JSON_UTF8).content(RestTestUtil.convertObjectToJsonBytes(keyAndPassword)))
                .andExpect(status().isBadRequest());
